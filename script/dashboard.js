...
const mensajes = [
  ...
  "Tienes una sonrisa que ilumina mis días. ✨",
  "A tu lado, cada instante se vuelve eterno. ⏳",
  "Si te quiero es porque eres mi amor, mi cómplice y todo. ❤️ (Mario Benedetti)",
  "No te quedes inmóvil al borde del camino, atrévete a amar. 🚶‍♂️💞 (Mario Benedetti)",
  "Tu amor es mi refugio en los días de tormenta. ⛈️💖",
  "Cada latido de mi corazón lleva tu nombre. 🎶",
  "No sé qué vi en ti, solo sé que no lo veo en nadie más. 💕",
  "De todas las historias de amor, la nuestra es mi favorita. 📖💑",
  "Amarte es mi mayor aventura. 🌎💘",
  "Porque contigo, cada día es un poema. 📜❤️ (Mario Benedetti)"
];
